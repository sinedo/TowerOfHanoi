...
while True:
    ...
    final = np.array([3,2,1])

    if np.array_equal(peg_A,final) or np.array_equal(peg_B,final) or np.array_equal(peg_C,final):
        print("We are done")
        break
